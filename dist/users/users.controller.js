...
exports.UsersManagerController = exports.UsersAdminController = void 0;
...
let UsersAdminController = class UsersAdminController {
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield this.usersService.createAdminUser(data);
            return {
                id: user._id,
                email: user.email,
                name: user.name,
    ...
    findAll(limit, offset, name, email, contactPhone) {
        return __awaiter(this, void 0, void 0, function* () {
...
__decorate([
    ...
    __param(4, (0, common_1.Query)('contactPhone')),
    __metadata("design:type", Function),
